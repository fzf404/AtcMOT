...
class opts(object):
    def __init__(self):
        ...
        # ATC独有参数
        self.parser.add_argument('--input-camera', type=int,
                                 default='0',
                                 help='输入摄像头')
        self.parser.add_argument('--input-stream', type=str,
                                 default='',
                                 help='输入视频流')
        self.parser.add_argument('--show', type=bool,
                                 default=False,
                                 help='True/False展示运算结果')
        ...
        self.parser.add_argument('--url', type=str,
                                 default='',
                                 help='发送帧请求接口地址')
        self.parser.add_argument('--device-id', type=int,
                                 default='1',
                                 help='设备号')
        self.parser.add_argument('--trigger', type=int,
                                 default='300',
                                 help='违法判断参数')
        self.parser.add_argument('--check-setp', type=int,
                                 default='3',
                                 help='违法检测间隔帧数')
